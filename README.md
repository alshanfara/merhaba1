...
.pmsgc {
    box-shadow: inset 0 1px 100px #008faf29,0 0 6px #fff!important;
    outline-offset: -4px
}
...
.fl.nosel.label.pnhead {
    background: #008faf!important;
    border-radius: 20px;
    font-family: 'jazeera',FontAwesome;
    font-size: 14px!important;
    box-shadow: inset -1px -1px 1px #6b2bf1, 0 0 8px rgb(255 255 255);
}
...
.light {
    background: repeating-linear-gradient(45deg,rgba(255,255,255,.8),rgb(255,255,255) 100px,#ffffffb0 0,#fff6f699 200px),repeating-linear-gradient(-45deg,rgba(255,255,255,.5),rgba(255,255,255,.93) 100px,#b3adadd1 0,#ffffffe6 200px)!important
}
...
.fitimg.fl.borderg.spic.corner.hand {
    ...
    border: 2px solid #a3a3a378!important;
    border-radius: 100px!important
}

label.tc.border.btn.label-info.fl {
    background: #a3a3a324!important;
...
.fl.u-pic {
    box-shadow: inset 0 1px 1px rgb(0 0 0 / 8%), 0 0 10px #6b2bf199;
}
...
.btn.fr.btn-success.fa.fa-refresh{
    background:#008faf00;
    border:1px  dashed  ;
        margin: 67px 0px -38px 0!important;
...
label.label.label-primary.mini.fl {
    ...
    margin: 0;
    border-left: 2px solid #ebd33e!important;
    padding: 1px 15px 0 0;
    border-radius: 0 0 0 1px!important;
    border-bottom: 1px solid #ebd33e!important;
    font-family: 'jazeera',FontAwesome;
...
div#tlogins .fade {
    ...
    height: 110px;
    -webkit-transform: matrix(1,0,0,1,0,128)!important;
}
...
ul.nav.nav-tabs {
    ...
    background-image: -webkit-linear-gradient( 45deg ,#692df0 25%,#1679bd 25%,#0189b4 50%,#b2cfe4 50%,#b2cfe4 75%,#b2cfe4 75%,#b2cfe4)!important;
}
...
a#asim7 {
    ...
    border-top: 4px solid #6b2bf1 !important;
    -webkit-transform: matrix(1,0,0,1,0,-18)!important;
    background: #008faf!important;
    0FONT-VARIANT: JIS04;
}

a#asim7,.ae.fa.label.label-primary.fa-user,div#tlogins button.btn.btn-primary,#as43,ul.nav.nav-tabs>li.active>a,ul.nav.nav-tabs,ul.nav.nav-tabs>li>a,.label-danger,.broadcasters,a.btn.minix.fa.fa-comment,button.btn,.label-primary,.btn-primary,.bg-primary,.label-primary:hover,.btn-primary:hover,.btn-primary:focus,label.fl.label.loginstat {
}
